#!/usr/bin/env python3
"""Validate multi-environment covariance models with synthetic data.

Optional real-trait checks use explicitly supplied local inputs and write
aggregate diagnostics and figures.
"""
