...
$B=32,128,512$ phase timings, scaled by the sealed full-cohort $B=32$ phases,
gives a point estimate near 2.2 hours at $B=1024$.  A conservative current
planning range is 2.2--2.8 hours to allow for repair and system-load variation.
This remains an extrapolation, not a completed $B=1024$ production timing, and
should be replaced by a measured value before a large production campaign.
