...
On tabla, a full $N_R=291{,}273$, $M=454{,}207$, $B=32$ EUR age calculation
completed its numerical work in 1,939.5 seconds and peaked at 4.05 GiB.  Its
feature, source, panel-preparation, and target phases took 523.3, 347.8, 0.18,
and 979.9 seconds.  The artifacts from this diagnostic were deliberately not
sealed: the native extension file was rebuilt during the run, and SUMMIT's
executable-inode guard rejected publication.  The timing and integrity counts
were recorded before that publication failure, but this is not a completed
...
seconds (5.23-fold), rather than 16-fold.  An affine fit to the measured
$B=32,128,512$ phase timings, scaled by the full-cohort $B=32$ phases, gives a
current $B=1024$ planning range of approximately 3--3.5 hours.  This is still
an extrapolation, not a completed $B=1024$ production timing.  It should be
replaced by a measured value before a large production campaign.
